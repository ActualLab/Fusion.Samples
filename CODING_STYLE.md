...
This document describes the coding conventions used in ActualLab.Fusion.Samples project that differ from standard .NET conventions. These conventions are shared with the main [ActualLab.Fusion](https://github.com/ActualLab/Fusion) repository.
...
#### File placement:
- `src/` contains all sample projects
